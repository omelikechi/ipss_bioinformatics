...
def preselection(X, y, selector, preselector_args=None):
	...
	preselector_args.pop('n_runs', None)
	preselector_args.pop('n_keep', None)
	...
	if selector in ['lasso', 'logistic_regression']:
		...
		n_keep = n_keep or 100
		preselector_args = preselector_args or {'max_depth':1, 'colsample_bynode':0.1, 'n_estimators':50, 'importance_type':'gain'}
		...
		preselect_indices = np.argsort(average_importances)[::-1][:n_keep]
