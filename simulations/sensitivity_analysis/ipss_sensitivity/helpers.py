...
from ipss_sensitivity.base_selectors import fit_gb_classifier, fit_gb_regressor, fit_l1_classifier, fit_l1_regressor, fit_rf_classifier, fit_rf_regressor
...
def selector_and_args(selector, selector_args):
	...
	if selector in selectors:
		...
		if selector == 'logistic_regression' and not selector_args:
			...
			selector_args = {'max_features':0.1, 'n_estimators':25}
		else:
			selector_args = {}
	else:
